...
```sh
grep -rl 'beecommerce' ./ | xargs sed -i '' 's/beecommerce/{YOUR INTEGRATION NAME}/g'
```
...
Want to contribute? Ping us on `beecommerce` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/beecommerce.git
    cd beecommerce
    ```
